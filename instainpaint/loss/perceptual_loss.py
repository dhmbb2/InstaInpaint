...
class Vgg19FeatureExtractor(nn.Module):
    ...
    def __init__(self, input_normalize_method="shift_scale"):
        """
        Implement the perceptual loss mentioned in https://arxiv.org/abs/1707.09405
        LRM authors mention this loss works better than LPIPS, and being used in the subsequent works of LRM.
